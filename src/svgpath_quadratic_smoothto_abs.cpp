...
SVGPath_Quadratic_SmoothTo_Abs::SVGPath_Quadratic_SmoothTo_Abs()
{

}

void SVGPath_Quadratic_SmoothTo_Abs::process(QQueue<QString>* commandQueue, QTextStream* gcode, TransformationStack trans)
{
    mGcode = gcode;
    mTrans = &trans;
    bool isOk = true;
