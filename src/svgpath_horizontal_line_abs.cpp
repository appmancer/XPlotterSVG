...
SVGPath_Horizontal_Line_Abs::SVGPath_Horizontal_Line_Abs()
{
 ...
 * */
void SVGPath_Horizontal_Line_Abs::process(QQueue<QString>* commandQueue, QTextStream* gcode, TransformationStack trans)
{
    bool isOk = true;
    double x;
